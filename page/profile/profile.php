                ...
                <div class="profile-header">
                    <form action="upload_foto.php" method="POST" enctype="multipart/form-data">
                        ...
                        <label for="foto_input">
                            <img src="../img/user/<?= htmlspecialchars($user['foto']) ?>" alt="Foto Profil"
                                style=" cursor: pointer;">
                        </label>

                        <input type="file" name="foto" id="foto_input" accept="image/*" style="display: none;"
                    ...
                    <div>
                        ...
                        <a href="edit_profile.php?field=nama" title="Edit Nama" style="text-decoration: none;">
                            Edit Profile<img src="../img/assets/pen.svg" alt="Edit"
                                style="width:16px; height:16px; cursor:pointer; margin-left:5px; ">
                        </a>
                    </div>
                </div>
