...
<body>
    ...
    <section class="info-container">
        <div class="info-box">
            <p>
                <strong>MasjidAid</strong> adalah platform digital yang berbasis online dan dikelola oleh komunitas
                untuk mempermudah donasi masjid di seluruh Indonesia.
            </p>
        </div>
    ...
    <section class="visi-misi">
        ...
        <div class="visi-container">
            <div class="visi-card">
                <h2>Visi</h2>
                <p>Menjadi platform donasi terpercaya untuk mendukung pembangunan dan kesejahteraan masjid secara
                    transparan.</p>
            </div>
        ...
        <div class="footer-container">
            ...
            <div class="footer-bottom">
                <div class="footer-social">
                    <a href="https://wa.me/085876335559?text=Assalamualaikum" target="_blank"><img
                            src="img/assets/whatsapp.png" alt="WhastApp"></a>
                    <a href="https://www.instagram.com/evannsm._/profilecard/?igsh=MTVvMzN5NWRmams2bA=="
                        target="_blank"><img src="img/assets/instagram.png" alt="YouTube"></a>
                    <a href="https://x.com/satriamhrdk_art?t=sXq56TSAp-1CvQScUs51cA&s=09" target="_blank"><img
                            src="img/assets/twitter.png" alt="Instagram"></a>
                </div>
