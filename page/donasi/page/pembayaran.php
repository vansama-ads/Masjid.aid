...
<body>
  <div class="container">
    <div class="card">
      ...
      <p class="thanks">Terimakasih <span class="highlight"><?= htmlspecialchars($user['nama']) ?></span> atas Donasi
        yang akan anda berikan pada :</p>
      ...
      <div class="qris-section">
        <div class="left">
          ...
          <div class="amount-box">
            ...
            <strong><span class="amount">Rp. <span class="pink">
                  <?= number_format($transaksi['jumlah'], 0, ',', '.') ?></span></span></strong>
          </div>
          <p class="note">Harap transfer sesuai nominal diatas (sampai 3 digit terakhir) agar dapat terkonfirmasi
            otomatis dan kebaikan ini dapat kami teruskan.</p>
        ...
        <div class="right">
          ...
          <?php if ($metode['kategori'] === 'bank'): ?>
            <div class="transfer-box">
              ...
              <ul>
                <li><strong><?= htmlspecialchars($metode['nama']) ?>:</strong>
                  <?= htmlspecialchars($metode['rekening']) ?></li>
              </ul>
            </div>
      ...
      <p style="font-size: 0.9em; color: gray;">
        Semua donasi dari platform ini disalurkan melalui rekening resmi Masjid.Aid sebelum diteruskan ke masjid tujuan.
        Setiap transaksi tercatat dan dilaporkan secara transparan.
      </p>
